...
from app.api.v1.admin import (
    ...
    extraction as admin_extraction,
...
api_router.include_router(chat_events.router, prefix="/subjects", tags=["subject-chat"])
...
api_router.include_router(admin_extraction.router,   prefix="/admin/extraction",  tags=["admin"])
